...
<?php endif; ?>
            <header class="main-header">
                ...
                <div class="main-header__side">
                    <?php if (isset($session['username'])): ?>
                        <a class="main-header__side-item button button--plus open-modal" href="add.php<?= "?project=".($_GET['project'] ?? '') ?>">Добавить задачу</a>
    ...
    <footer class="main-footer">
        <div class="container">
            ...
            <?php if (isset($session['username'])): ?>
                <a class="main-footer__button button button--plus" href="add.php<?= "?project=".($_GET['project'] ?? '') ?>">Добавить задачу</a>
            <?php endif; ?>
